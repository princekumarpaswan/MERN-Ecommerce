...
const Footer = () => {
    return (
        <>
            ...
            <footer className="bg-[#E8BD0D] dark:bg-[#E8BD0D] mb-[150px]  place-items-end">
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 place-items-end lg:py-8">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            <div>
                                ...
                                <ul className="text-gray-600 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <a href="/home" className="hover:underline">About Us</a>
                                    </li>
                                    <li>
                                        <a href="/home" className="hover:underline">Contact Us</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                ...
                                <ul className="text-gray-600 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <a href="https://github.com/princekumarpaswan" className="hover:underline ">Github</a>
                                    </li>
                                    <li>
                                        <a href="https://github.com/princekumarpaswan" className="hover:underline">Discord</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                ...
                                <ul className="text-gray-600 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <a href="https://github.com/princekumarpaswan" className="hover:underline">Privacy Policy</a>
                                    </li>
                                    <li>
                                        <a href="https://github.com/princekumarpaswan" className="hover:underline">Terms &amp; Conditions</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/home" className="hover:underline">PrinceKumar™</a>. All Rights Reserved.
                        </span>
                        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                            <a href="https://github.com/princekumarpaswan" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
